...
class Bill_App:
    def __init__(self, root):
        ...
        self.txt_logout_btn = Button(self.root, text="Logout",command=self.logout_window, font="arail 15 bold", bg="cadetblue", fg="white")
        self.txt_logout_btn.place(x=1200, y=15, width=120, height=45)
        ...
        #----------Total product prices and Tax Variable--------
 ...
 #......Customer Deatials Frame
        F1 = LabelFrame(self.root,bd=10,relief=GROOVE,text="Customer Details", font=("time new roman", 15,"bold"),fg="gold", bg=bg_color)
        F1.place(x=0, y=80, relwidth=1)
        cname_lbl=Label(F1,text="Customer Name",bg=bg_color,fg="white",font=("time new roman", 15,"bold")).grid(row=0, column=0, padx=20, pady=5)
        cname_txt=Entry(F1, width=15,textvariable=self.c_name, font="arial 15",bd=7,relief=SUNKEN).grid(row=0, column=1, pady=5,padx=10)
        
        cphn_lbl=Label(F1,text="Phone No.",bg=bg_color,fg="white",font=("time new roman", 15,"bold")).grid(row=0, column=2, padx=20, pady=5)
        cphn_txt=Entry(F1, width=15,textvariable=self.c_phone, font="arial 15",bd=7,relief=SUNKEN).grid(row=0, column=3, pady=5,padx=10)

        cbill_lbl=Label(F1,text="Bill NUmber",bg=bg_color,fg="white",font=("time new roman", 15,"bold")).grid(row=0, column=4, padx=20, pady=5)
        ...
        #======cosmatic Freame=====
        F2=LabelFrame(self.root,bd=10,relief=GROOVE,text="Cosmatics", font=("time new roman", 15,"bold"),fg="gold", bg=bg_color)
        ...
        Face_w_lbl=Label(F2,text="Face Whas",font=("times new roman",16,"bold"),bg=bg_color,fg="lightgreen").grid(row=2,column=0,padx=10,pady=10,sticky="w")
        ...
        g5_text=Entry(F3,width=10,textvariable=self.suger,font=("times new roman",16,"bold"),bd=5,relief=SUNKEN).grid(row=4,column=1,padx=10,pady=10)
        ...
        c6_text=Entry(F4,width=10,textvariable=self.limca,font=("times new roman",16,"bold"),bd=5,relief=SUNKEN).grid(row=4,column=1,padx=10,pady=10)
        ...
        c1_txt=Entry(F6,width=15,textvariable=self.cosmetic_tax,font="arial 10 bold",bd=7,relief=SUNKEN).grid(row=0,column=3,padx=10,pady=1)
        ...
        c2_txt=Entry(F6,width=15,textvariable=self.grocery_tax,font="arial 10 bold",bd=7,relief=SUNKEN).grid(row=1,column=3,padx=10,pady=1)
        ...
        c3_txt=Entry(F6,width=15,textvariable=self.cold_drink_tax,font="arial 10 bold",bd=7,relief=SUNKEN).grid(row=2,column=3,padx=10,pady=1)

        btn_F=Frame(F6, bd=7, relief=GROOVE)
        btn_F.place(x=750,width=580,height=105)

        total_btn=Button(btn_F,text="Total",command=self.total,bg="cadetblue",width=10,font="arail 15 bold",bd=2,fg="white",pady=15).grid(row=0, column=0,padx=5,pady=5)
        GBill_btn=Button(btn_F,text="Genrate Bill",command=self.bill_area,bg="cadetblue",width=10,font="arail 15 bold",bd=2,fg="white",pady=15).grid(row=0, column=1,padx=5,pady=5)
        Clear_btn=Button(btn_F,text="Clear",command=self.clear_data,bg="cadetblue",width=10,font="arail 15 bold",bd=2,fg="white",pady=15).grid(row=0, column=2,padx=5,pady=5)
        Exit_btn=Button(btn_F,text="Exit",command=self.Exir_app,bg="cadetblue",width=10,font="arail 15 bold",bd=2,fg="white",pady=15).grid(row=0, column=3,padx=5,pady=5)
        self.welcome_bill()
    ...
    def total(self):
        ...
        self.c_hs_p=self.spray.get()*130
        ...
        self.g_f_p=self.food_oil.get()*130
        ...
        self.d_c_p=self.cock.get()*45
        self.d_f_p=self.frooti.get()*35
        self.d_t_p=self.thumsup.get()*35
    ...
    def bill_area(self):
        if self.c_name.get()=="" or self.c_phone.get()=="":
            ...
            if self.thumsup.get()!=0:
                self.txtarea.insert(END,f"\n Thumbs Up\t\t{self.thumsup.get()}\t\t{self.d_t_p}")
            if self.limca.get()!=0:
